...
app.get('/aviary', function (req, res) {
   ...
   var BLAH = "{'metadata':{'imageorigsize':[1000,675]},'actionlist':[{'action':'setfeathereditsize','width':1000,'height':675},{'action':'thresh','params':[],'flatten':true}]}";
   ...
   var params = 
        { api_key: 'd3954246e',
          ...
          cellwidth: -1,
          cols: -1,
          filepath: 'http://freezing-lightning-2366.herokuapp.com/frequencyhigh_3872x2592_vegetation_ep.jpg',
          filterid: -1,
          format: 'jpg',
          hardware_version: 1,
          platform: 'web',
   ...
   var bigString = "e8068162c"+
                   ...
                   "cellwidth-1"+
                   "cols-1"+
                   "filepath"+ encodeURIComponent("http://freezing-lightning-2366.herokuapp.com/frequencyhigh_3872x2592_vegetation_ep.jpg")+
                   "filterid-1"+
                   "formatjpg"+
                   "hardware_version1"+
                   "platformweb"+
